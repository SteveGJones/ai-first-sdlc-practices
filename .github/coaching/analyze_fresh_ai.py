...
class FreshAIAnalyzer:
    ...
    def __init__(self):
        self.formations = {
            '4-3-3 Builder': {
                'keywords': ['web', 'application', 'api', 'frontend', 'backend', 'full-stack', 'crud'],
                'specialists': [
                    ('solution-architect', 'Your tactical mastermind for system design'),
                    ('ai-test-engineer', 'Your quality guardian for bulletproof code'),
                    ('devops-specialist', 'Your deployment expert for smooth releases')
                ]
            },
            '3-5-2 Orchestrator': {
                'keywords': ['microservices', 'distributed', 'kubernetes', 'cloud', 'scale', 'enterprise'],
                'specialists': [
            ...
            '3-4-3 Designer': {
                'keywords': ['ui', 'ux', 'design', 'user', 'experience', 'interface', 'mobile'],
                'specialists': [
            ...
            '5-3-2 Architect': {
                'keywords': ['architecture', 'design', 'patterns', 'framework', 'platform', 'infrastructure'],
                'specialists': [
        ...
        self.skill_levels = {
            ...
            'intermediate': ['some', 'moderate', 'familiar', 'worked with', 'experience'],
    ...
    def prioritize_specialist(self, specialists: List[Tuple[str, str]], 
                            priority: str) -> List[Tuple[str, str]]:
...
def main():
    ...
    parser.add_argument('--output', choices=['formation', 'json'], default='formation',
                       help='Output format')
