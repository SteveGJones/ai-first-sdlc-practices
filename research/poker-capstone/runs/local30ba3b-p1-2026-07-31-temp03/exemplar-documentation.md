...
1. **Pot creation**: Pot is created for each pot level in the pot allocation algorithm
2. **Pot allocation**: Pot is allocated to the winner(s) of the pot
3. **Pot allocation**: Pot is allocated to the winner(s) of the pot
...
1. **Pot creation**: Pot is created for each pot level