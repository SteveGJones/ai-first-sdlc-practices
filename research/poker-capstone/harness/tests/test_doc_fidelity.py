...
def test_empty_text_is_zero_score() -> None:
    result = score_doc_checklist("")
    assert result.score == 0.0


def test_thorough_description_scores_high() -> None:
    text = """
...
def test_partial_description_scores_between() -> None:
...
def test_build_judge_prompt_includes_facts_and_doc() -> None:
