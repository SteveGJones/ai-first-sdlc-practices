...
```
Drift detected (warning only). Run /sdlc-knowledge-base:kb-rebuild-indexes to refresh.
```
Exit 0.
...
Run /sdlc-knowledge-base:kb-rebuild-indexes to refresh, then re-run validation.
```
Exit 1.
...
/sdlc-knowledge-base:kb-staleness-check --strict
```
...
claude /sdlc-knowledge-base:kb-staleness-check --strict
```
...
Then run /sdlc-knowledge-base:kb-staleness-check --strict
...
```
/sdlc-knowledge-base:kb-staleness-check
