...
def format_id(parsed: ParsedId) -> str:  # implements: DES-assured-id-system-001
...
def is_positional(parsed: ParsedId) -> bool:  # implements: DES-assured-id-system-001
...
def render_id_registry(records: List[IdRecord]) -> str:  # implements: DES-assured-id-system-002
