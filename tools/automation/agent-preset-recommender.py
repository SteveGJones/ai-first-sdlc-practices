...
AGENT_PRESETS = {
    "web-app": {
        ...
        "recommended_agents": ["devops-specialist", "integration-orchestrator", "performance-engineer"],
        "optional_agents": ["documentation-architect", "sre-specialist", "security-architect"]
    },
    "api": {
        "name": "API Service",
        "description": "REST/GraphQL API or microservice",
        "core_agents": ["sdlc-enforcer", "solution-architect", "integration-orchestrator"],
        "recommended_agents": ["test-manager", "performance-engineer", "devops-specialist"],
        "optional_agents": ["documentation-architect", "sre-specialist", "security-architect"]
    },
    "ai-app": {
        ...
        "recommended_agents": ["langchain-architect", "prompt-engineer", "test-manager"],
        "optional_agents": ["mcp-server-architect", "agent-developer", "performance-engineer"]
    },
    "library": {
        "name": "Library/Package",
        "description": "Reusable library or package for distribution",
        "core_agents": ["sdlc-enforcer", "solution-architect", "documentation-architect"],
    ...
    "data-pipeline": {
        ...
        "core_agents": ["sdlc-enforcer", "solution-architect", "integration-orchestrator"],
        "recommended_agents": ["performance-engineer", "test-manager", "devops-specialist"],
    ...
    "enterprise": {
        ...
        "recommended_agents": ["compliance-auditor", "delivery-manager", "test-manager"],
...
class ProjectAnalyzer:
    ...
    def _parse_package_json(self, file_path: Path, deps: Dict):
        ...
        try:
            ...
            frameworks = ["react", "vue", "angular", "next", "nuxt", "express", "fastify", "nest"]
    ...
    def _analyze_structure(self) -> Dict:
        ...
        ci_files = [".github/workflows", ".gitlab-ci.yml", "Jenkinsfile", ".circleci", "azure-pipelines.yml"]
        ...
        if (self.project_path / "terraform").exists() or list(self.project_path.glob("*.tf")):
    ...
    def _detect_ai_usage(self) -> Dict:
        ...
        ai_libs = ["openai", "anthropic", "langchain", "transformers", "tensorflow", "pytorch", "scikit-learn"]
    ...
    def _determine_project_type(self) -> str:
        ...
        if (structure.get("has_k8s") or structure.get("has_terraform") or 
            self.characteristics.get("project_size") == "enterprise"):
            return "enterprise"
...
@click.option('--type', 'project_type', type=click.Choice(list(AGENT_PRESETS.keys())), 
