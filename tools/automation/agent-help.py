...
AGENT_CATALOG = {"sdlc-enforcer": {"keywords": ["process",
                                                "workflow",
                                                "sdlc",
                                                "framework",
                                                "compliance",
                 ...
                 "solution-architect": {"keywords": ["architecture",
                                        "design",
                                                     "system",
                                                     "scalability",
                                                     "integration",
                 ...
                 "security-architect": {"keywords": ["security",
                                        "threat",
                                                     "vulnerability",
                                                     "authentication",
                                                     "authorization",
                 ...
                 "language-python-expert": {"keywords": ["python",
                                            "pythonic",
                                                         "pep",
                                                         "django",
                                                         "flask",
                 ...
                 "javascript-expert": {"keywords": ["javascript",
                                       "js",
                                                    "typescript",
                                                    "node",
                                                    "npm",
                 ...
                 "react-architect": {"keywords": ["react",
                                     "hooks",
                                                  "redux",
                                                  "context",
                                                  "component",
                 ...
                 "database-architect": {"keywords": ["database",
                                        "sql",
                                                     "nosql",
                                                     "schema",
                                                     "query",
                 ...
                 "kubernetes-architect": {"keywords": ["kubernetes",
                                          "k8s",
                                                       "container",
                                                       "docker",
                                                       "helm",
                 ...
                 "performance-reviewer": {"keywords": ["performance",
                                          "speed",
                                                       "optimization",
                                                       "slow",
                                                       "bottleneck",
                 ...
                 "ml-architect": {"keywords": ["machine learning",
                                  "ml",
                                               "ai",
                                               "model",
                                               "training",
                 ...
                 "frontend-performance": {"keywords": ["frontend",
                                          "performance",
                                                       "lighthouse",
                                                       "core web vitals",
                                                       "loading",
                 ...
                 "accessibility-expert": {"keywords": ["accessibility",
                                          "a11y",
                                                       "wcag",
                                                       "screen reader",
                                                       "aria",
                 ...
                 "critical-goal-reviewer": {"keywords": ["review",
                                            "goals",
                                                         "requirements",
                                                         "validation",
                                                         "alignment",
                 ...
                 "ai-first-kick-starter": {"keywords": ["setup",
                                           "kickstart",
                                                        "framework",
                                                        "sdlc",
                                                        "initialization",
                 ...
                 "github-integration-specialist": {"keywords": ["github",
                                                   "git",
                                                                "pr",
                                                                "branch",
                                                                "protection",
                 ...
                 "ai-solution-architect": {"keywords": ["ai",
                                           "ml",
                                                        "machine learning",
                                                        "llm",
                                                        "architecture",
                 ...
                 "project-plan-tracker": {"keywords": ["project",
                                          "plan",
                                                       "tracking",
                                                       "progress",
                                                       "deliverables",
...
def find_agents(query: str) -> List[Dict]:
    ...
    for agent_name, agent_info in AGENT_CATALOG.items():
        ...
        # Check helps_with
        if any(word in agent_info["helps_with"].lower()
               for word in query_words):
            score += 3

        # Check when_to_use
        if any(word in agent_info["when_to_use"].lower()
               for word in query_words):
            score += 2
...
@click.option("--install", "-i", is_flag=True,
              help="Install recommended agent")
def main(query, install):
    ...
    if not matches:
        console.print(
            "[yellow]No specific agents found for that query.[/yellow]")
        console.print(
            "Try: agent-help testing, security, performance, or architecture")
        return
    ...
    if not check_installed(best_match["name"]):
        ...
        if install:
            ...
            if result.returncode == 0:
                console.print(
                    f"[green]✓ Installed {best_match['name']}[/green]")
            else:
