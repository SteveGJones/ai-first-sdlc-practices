...
AGENT_CATALOG = {
    ...
    'solution-architect': {
        'keywords': ['architecture', 'design', 'system', 'scalability', 'integration', 'technology'],
    ...
    'security-architect': {
        'keywords': ['security', 'threat', 'vulnerability', 'authentication', 'authorization', 'compliance'],
    ...
    'react-architect': {
        'keywords': ['react', 'hooks', 'redux', 'context', 'component', 'jsx', 'frontend'],
    ...
    'database-architect': {
        'keywords': ['database', 'sql', 'nosql', 'schema', 'query', 'optimization', 'migration'],
    ...
    'kubernetes-architect': {
        'keywords': ['kubernetes', 'k8s', 'container', 'docker', 'helm', 'deployment', 'scaling'],
    ...
    'performance-reviewer': {
        'keywords': ['performance', 'speed', 'optimization', 'slow', 'bottleneck', 'profiling'],
    ...
    'ml-architect': {
        'keywords': ['machine learning', 'ml', 'ai', 'model', 'training', 'mlops', 'tensorflow', 'pytorch'],
    ...
    'frontend-performance': {
        'keywords': ['frontend', 'performance', 'lighthouse', 'core web vitals', 'loading', 'rendering'],
    ...
    'accessibility-expert': {
        'keywords': ['accessibility', 'a11y', 'wcag', 'screen reader', 'aria', 'inclusive'],
...
def show_quick_help():
    ...
    console.print(Panel.fit(
        ...
        "\n".join(f"  {icon} {name:<15} → {cmd}" for (name, cmd), (icon, _) in 
                  zip([(s[0].replace(s[0].split()[0], s[0].split()[0][2:]), s[1]) for s in scenarios],
                      scenarios)),
        border_style="blue"
    ))
