...
class ProjectAnalyzer:
    ...
    def _parse_package_json(self):
        ...
        try:
            ...
            if 'typescript' in deps:
                self.analysis['languages']['typescript'] = self.analysis['languages'].get('typescript', {'files': 0, 'percentage': 0})
    ...
    def _analyze_kubernetes(self):
        ...
        k8s_indicators = ['deployment.yaml', 'service.yaml', 'configmap.yaml', 
                         'ingress.yaml', 'kustomization.yaml']
...
def display_analysis(analysis: Dict):
    ...
    if analysis['languages']:
        ...
        for lang, info in sorted(analysis['languages'].items(), 
