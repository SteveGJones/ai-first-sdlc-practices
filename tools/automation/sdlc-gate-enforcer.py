...
class SDLCGateEnforcer:
    ...
    def _get_gate_config(self, gate_name: str) -> Dict:
        ...
        level_overrides = gate_config.get('level_overrides', {}).get(self.current_level, {})
    ...
    def approve_gate(self, gate_name: str, agent_name: str):
        ...
        if consensus_type == 'all':
            ...
            approved_count = sum(1 for agent in required_agents 
    ...
    def can_proceed_to_next_phase(self, current_phase: str, next_phase: str) -> Tuple[bool, List[str]]:
        ...
        phase_order = ['requirements', 'design', 'implementation', 'review', 'deployment']
