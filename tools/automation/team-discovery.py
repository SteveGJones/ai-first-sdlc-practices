...
class ProjectArchetype:
    ...
    def __init__(self, name: str, description: str, formation: str, 
                 core_agents: List[str], characteristics: Dict[str, Any]):
        self.name = name
...
ARCHETYPES = {
    "builder": ProjectArchetype(
        ...
        formation="3-3-2",
        core_agents=[
            "sdlc-enforcer", "solution-architect", "critical-goal-reviewer",
            "language-expert", "test-manager", "technical-writer"
        ],
        characteristics={
            "complexity": "low",
            "integrations": "0-2",
    ...
    "specialist": ProjectArchetype(
        ...
        core_agents=[
            "sdlc-enforcer", "solution-architect", "critical-goal-reviewer",
            "domain-specialist", "compliance-auditor", "language-expert",
            "test-manager", "technical-writer", "devops-specialist"
        ],
        characteristics={
            "complexity": "medium",
            "integrations": "2-4",
    ...
    "innovator": ProjectArchetype(
        ...
        formation="4-4-2", 
        core_agents=[
            "sdlc-enforcer", "ai-solution-architect", "critical-goal-reviewer",
            "prompt-engineer", "langchain-architect", "ai-test-engineer",
            "performance-engineer", "language-expert", "test-manager",
            "devops-specialist"
        ],
        characteristics={
            "complexity": "high",
    ...
    "transformer": ProjectArchetype(
        ...
        core_agents=[
            "sdlc-enforcer", "solution-architect", "critical-goal-reviewer",
            "integration-orchestrator", "devops-specialist", "sre-specialist",
            "security-specialist", "compliance-auditor", "performance-engineer",
            "language-expert"
        ],
        characteristics={
            "complexity": "high",
    ...
    "orchestrator": ProjectArchetype(
        ...
        formation="4-4-2-1",
        core_agents=[
            "sdlc-enforcer", "orchestration-architect", "a2a-architect",
            "agent-developer", "mcp-server-architect", "integration-orchestrator",
            "ai-solution-architect", "performance-engineer", "devops-specialist",
            "sre-specialist", "critical-goal-reviewer", "mcp-quality-assurance"
        ],
        characteristics={
            "complexity": "extreme",
            "integrations": "9+",
    ...
    def run_assessment(self) -> str:
        ...
        self.responses["project_type"] = self.ask_question(
            ...
            [
                ...
                ("Domain-specific application (fintech, healthcare, etc.)", {"specialist": 3, "transformer": 1}),
                ("AI/ML application or AI-enhanced features", {"innovator": 3, "orchestrator": 1}),
                ("Enterprise integration or microservices", {"transformer": 3, "orchestrator": 1}),
                ("Multi-agent system or agent-to-agent communication", {"orchestrator": 3, "innovator": 1})
            ]
        )
        ...
        self.responses["integrations"] = self.ask_question(
            ...
            [
                ("0-1 systems (mostly self-contained)", {"builder": 2, "specialist": 1}),
                ("2-3 systems (moderate integration)", {"specialist": 2, "innovator": 1, "transformer": 1}),
                ("4-6 systems (complex integration)", {"transformer": 2, "orchestrator": 1, "innovator": 1}),
                ("7+ systems (enterprise-scale integration)", {"orchestrator": 3, "transformer": 2})
            ]
        )
        ...
        self.responses["complexity"] = self.ask_question(
            ...
            [
                ("Low - Well-understood patterns and technologies", {"builder": 3, "specialist": 1}),
                ("Medium - Some new technologies, moderate challenges", {"specialist": 2, "innovator": 1, "transformer": 1}),
                ("High - Cutting-edge tech, significant technical challenges", {"innovator": 3, "orchestrator": 1}),
                ("Extreme - Research-level problems, unprecedented challenges", {"orchestrator": 3, "innovator": 2})
            ]
        )
        ...
        self.responses["compliance"] = self.ask_question(
            ...
            [
                ...
                ("Standard industry compliance (basic security, etc.)", {"specialist": 2, "innovator": 1}),
                ("Heavy compliance (SOX, HIPAA, PCI-DSS, etc.)", {"transformer": 3, "specialist": 1}),
                ("Extreme compliance (government, defense, finance)", {"transformer": 3, "orchestrator": 1})
            ]
        )
        ...
        self.responses["collaboration"] = self.ask_question(
            ...
            [
                ("Simple - Agents work mostly independently", {"builder": 2, "specialist": 1}),
                ("Moderate - Some coordination between agents needed", {"specialist": 2, "innovator": 1}),
                ("Complex - Frequent agent-to-agent communication", {"innovator": 2, "transformer": 1, "orchestrator": 1}),
                ("Extreme - Agents must orchestrate complex workflows", {"orchestrator": 3, "transformer": 1})
            ]
        )
        ...
        self.responses["performance"] = self.ask_question(
            ...
            [
                ("Basic - Handle expected load without issues", {"builder": 2, "specialist": 1}),
                ("Moderate - Good performance under normal conditions", {"specialist": 2, "innovator": 1}),
                ("High - Must perform well under heavy load", {"transformer": 2, "innovator": 2, "orchestrator": 1}),
                ("Extreme - Mission-critical performance requirements", {"orchestrator": 3, "transformer": 2})
            ]
        )
        ...
        self.responses["change_tolerance"] = self.ask_question(
            ...
            [
                ("Rarely - Requirements are well-defined and stable", {"builder": 2, "transformer": 1}),
                ("Occasionally - Some changes expected", {"specialist": 2, "builder": 1}),
                ("Frequently - Agile environment with regular changes", {"innovator": 2, "specialist": 1}),
                ("Constantly - Experimental/research environment", {"orchestrator": 2, "innovator": 2})
            ]
        )
...
@click.option('--format', type=click.Choice(['json', 'markdown']), default='markdown', help='Output format')
def main(interactive: bool, output: str, format: str):
    ...
    try:
        ...
        click.echo(f"2. Install Phase 1 agents: {', '.join(recommendations['installation_phases']['phase_1_foundation']['agents'])}")
        click.echo(f"3. Run: python tools/automation/validate-team-readiness.py --formation {winning_archetype}")
        click.echo(f"4. Begin chemistry development exercises")
...
def generate_markdown_report(recommendations: Dict[str, Any], responses: Dict[str, str], scores: Dict[str, int]) -> str:
    ...
    report = f"""# AI Team Discovery Report
