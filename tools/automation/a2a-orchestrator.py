...
class A2AOrchestrator:
    ...
    def _load_default_formation(self):
        ...
        formation = {
            ...
            "solution-architect": AgentCapability(
                ...
                primary_passes_to=["ai-solution-architect", "python-expert", "devops-specialist"],
                receives_from=["all"],
    ...
    def start_workflow(self, workflow_name: str, initiator: str, description: str) -> str:
        ...
        if workflow_name == "feature_development":
            sequence = ["solution-architect", "ai-solution-architect", "python-expert", "ai-test-engineer", "critical-goal-reviewer"]
        elif workflow_name == "issue_resolution":
            sequence = ["sre-specialist", "relevant-specialist", "test-manager", "retrospective-miner"]
        else:
...
@click.option('--type', 'msg_type', default='request', type=click.Choice(['request', 'status_update', 'escalation', 'handoff']))
