...
class LeadershipDemoScenarios:
    ...
    def demo_emerging_billy_wright_leader(self) -> Dict[str, Any]:
        ...
        crisis_moments = [
            {
                ...
                'lessons': ['Emergency protocols worked', 'Team coordination improved', 'Need better monitoring']
            },
            {
                ...
                'lessons': ['Security scanning automation needed', 'Communication protocols effective']
            },
            {
                ...
                'lessons': ['Mentoring under pressure is effective', 'Documentation needs improvement']
            }
        ]
        ...
        click.echo(f"   Key Strengths: Real-time decision making, team rallying, technical expertise")
    ...
    def demo_emerging_stan_cullis_leader(self) -> Dict[str, Any]:
        ...
        strategic_moments = [
            {
                ...
                'lessons': ['Architecture decisions impact velocity', 'Team needs growth paths', 'Process improvements needed']
            },
            {
                ...
                'lessons': ['Structured mentoring works', 'Growth tracking important', 'Knowledge sharing improves team']
            },
            {
                ...
                'lessons': ['System thinking prevents problems', 'Standards enable scale', 'Communication is critical']
            }
        ]
        ...
        click.echo(f"   Key Strengths: Long-term planning, talent development, system design")
    ...
    def demo_team_assessment(self) -> Dict[str, Any]:
        ...
        total_billy_wright = (alex_result['score'] + sarah_result.get('billy_wright_score', 70) + 
                             marcus_result['billy_wright_score']) / 3
        total_stan_cullis = (alex_result.get('stan_cullis_score', 60) + sarah_result['score'] + 
                           marcus_result['stan_cullis_score']) / 3
        ...
        return {
            ...
            'strengths': ['crisis_response', 'strategic_vision', 'leadership_diversity', 'mentoring_culture'],
            'opportunities': ['elena_development', 'cross_training', 'documentation', 'scaling']
        }
...
@click.option('--scenario', 
              type=click.Choice([
                  'emerging_billy_wright', 'emerging_stan_cullis', 'dual_legend',
                  'team_assessment', 'crisis_response', 'all'
              ]),
              default='all',
