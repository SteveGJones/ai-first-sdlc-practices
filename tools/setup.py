...
class AIFirstSDLCSetup:
    ...
    def setup_templates(self, force: bool = False) -> bool:
        ...
        # Copy templates
        templates_to_copy = [
            ("feature-proposal.md", "docs/feature-proposals/template-feature-proposal.md"),
    ...
    def setup_pre_commit_hooks(self, force: bool = False) -> bool:
        ...
        source = self.tools_dir / "validation" / ".pre-commit-config.yaml"
    ...
    def create_config_file(self):
        ...
        print(f"   ✅ Created .ai-sdlc.json configuration")
