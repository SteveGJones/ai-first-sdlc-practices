...
"""
    ...
    def _task_explosion(self, clarity: Dict, team: Dict, architecture: Dict) -> List[Dict]:
        ...
        # Critical path tasks
        critical = [
            {"task": "Set up repository and CI/CD", "owner": "devops-specialist", "hours": 2},
            {"task": f"Design {clarity['CORE']} architecture", "owner": team['team']['captain'], "hours": 4},
            {"task": "Create database schema", "owner": "database-architect", "hours": 3},
            {"task": "Build API endpoints", "owner": "api-architect", "hours": 6},
            {"task": "Implement core feature", "owner": team['team']['specialist'], "hours": 8},
        ...
        print(f"📅 With {len(team['team'])} people: {total_hours/len(team['team']):.1f} hours")
