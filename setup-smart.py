...
"""
    ...
    def print_next_steps(self):
        ...
        print("   python tools/automation/agent-installer.py --install <agent-name>")
        print("   Example: python tools/automation/agent-installer.py --install mcp-server-architect")
        print("   ")
        ...
        print("   - List all available agents: python tools/automation/agent-installer.py --list")
