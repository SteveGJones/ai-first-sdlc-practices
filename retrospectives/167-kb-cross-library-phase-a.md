...
- User-scope JSON registry at `~/.sdlc/` is the correct home for corporate library paths. Project-scope activation (`.sdlc/libraries.json`) references registry entries by name only — paths never appear in the project repo.
