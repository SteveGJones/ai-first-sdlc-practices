...
class ContextManager:
    ...
    def create_handoff_document(self, 
    ...
    def _generate_handoff_markdown(self, handoff: Dict[str, Any], 
                                  session_id: str) -> str:
    ...
    def create_implementation_snapshot(self, 
                                     feature_name: str,
                                     phase: str,
    ...
    def list_contexts(self, context_type: Optional[str] = None, 
                     limit: int = 10) -> List[Dict[str, Any]]:
        """List available contexts"""
        contexts = []
        
        for file in sorted(self.context_history_dir.glob("*.json"), 
...
def main():
    ...
    save_parser.add_argument("type", choices=["work", "handoff", "debug", "custom"],
                            help="Context type")
    ...
    handoff_parser.add_argument("--completed", nargs="+", default=[], 
                               help="Completed tasks")
    handoff_parser.add_argument("--current", help="Current task in progress")
    handoff_parser.add_argument("--next", dest="next_tasks", nargs="+", default=[],
    ...
    snapshot_parser = subparsers.add_parser("snapshot", 
                                          help="Create implementation snapshot")
    ...
    if args.command == "save":
        ...
        if not contexts:
            ...
            for ctx in contexts:
                ...
                print(f"{ctx['session_id']:<10} {ctx['type']:<20} "
