...
class TestAIFriendlyTemplates(unittest.TestCase):
    ...
    def test_claude_md_template_structure(self) -> None:
    ...
    def test_gitignore_ai_tools_coverage(self) -> None:
    ...
    def test_retrospective_template_guidance(self) -> None:
...
class TestAIWorkflowIntegration(unittest.TestCase):
    ...
    def test_validation_messages_clarity(self) -> None:
